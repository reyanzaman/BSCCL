 ...
 * @author reyan
 */
public class SendApplicationController implements Initializable {

    @FXML
    private ComboBox<?> applicationTypeField;
    @FXML
    ...
    @FXML
    private void sendApplicationOnClick(ActionEvent event) {
    }
